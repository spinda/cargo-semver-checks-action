...
| `baseline-root`      | Path to a directory containing baseline crate source. If not specified, the crate latest version is pulled from the registry and used as the baseline. | |
